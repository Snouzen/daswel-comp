...
- Workspace ID: `e9fe6a43-ba5a-45fd-83ff-81ce32ec47f3`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/e9fe6a43-ba5a-45fd-83ff-81ce32ec47f3.
...
2. `npx ngodingpakeai connect --workspace e9fe6a43-ba5a-45fd-83ff-81ce32ec47f3 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/e9fe6a43-ba5a-45fd-83ff-81ce32ec47f3. Only pass on links the CLI actually printed — never assemble one from an id yourself.
