...
export const contactDepartments: ContactDepartment[] = [
  {
    ...
    email: "daswellindonesiagroup@gmail.com",
    phone: "+62 878 8590 2289",
    whatsappMessage:
      "Halo Tim Sales Daswell Indonesia, saya ingin konsultasi mengenai unit alat berat dan meminta surat penawaran harga resmi.",
  },
  {
    id: "dept-technical",
    ...
    phone: "+62 878 8590 2289",
    whatsappMessage:
      "Halo Tim Teknis Daswell Indonesia, saya membutuhkan informasi layanan purna jual, servis berkala, dan suku cadang unit.",
  },
  {
    id: "dept-partnership",
    ...
    phone: "+62 878 8590 2289",
    whatsappMessage:
      "Halo Manajemen Daswell Indonesia, saya tertarik untuk mendiskusikan potensi kemitraan dan kerjasama bisnis strategis.",
  },
];
...
export const quickInquiries: QuickInquiry[] = [
  {
    ...
    prefilledText:
      "Halo Daswell Indonesia, saya ingin meminta katalog dan brosur spesifikasi unit alat berat.",
  },
  {
    id: "inq-quote",
    ...
    prefilledText:
      "Halo Daswell Indonesia, saya ingin meminta surat penawaran harga (quotation) resmi untuk unit proyek kami.",
  },
  {
    id: "inq-demo",
    ...
    prefilledText:
      "Halo Daswell Indonesia, saya ingin menjadwalkan kunjungan untuk melihat langsung demo unit di lokasi Anda.",
  },
  {
    id: "inq-service",
    ...
    prefilledText:
      "Halo Daswell Indonesia, saya membutuhkan informasi garansi dan ketersediaan suku cadang alat berat.",
  },
];
